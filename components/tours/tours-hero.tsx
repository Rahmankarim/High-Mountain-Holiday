    ...
    <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-card mb-6">Our Tours & Packages</h1>
          <p className="text-xl text-card/80">
            From challenging mountain expeditions to immersive cultural journeys, find your perfect Pakistan adventure.
          </p>
        </motion.div>
      </div>
    </section>
